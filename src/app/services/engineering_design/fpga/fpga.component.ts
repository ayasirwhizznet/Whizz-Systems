...
@Component({
  selector: 'app-fpga',
  standalone: true,
  imports: [CommonModule, ServicesHeroComponent, ServicesBenefits1Component, ServicesContactExpertsComponent],
...
export class FpgaComponent {
  ...
  benefits:any[] = [
    {imgUrl: '../../../../assets/fpga/benefits.png', title: 'Extensive Expertise', desc: 'Over 30 years of successful FPGA project delivery.'},
    {imgUrl: '../../../../assets/fpga/benefits.png', title: 'Comprehensive Services', desc: 'End-to-end design, firmware, and software capabilities.'},
    {imgUrl: '../../../../assets/fpga/benefits.png', title: 'Cutting-Edge Tools', desc: 'Proficiency in Vivado, Quartus Prime, Lattice Diamond, and more.'},
    {imgUrl: '../../../../assets/fpga/benefits.png', title: 'Cloud Integration', desc: 'Scalable IoT solutions with AWS, Google Cloud, and Azure IoT.'},
    {imgUrl: '../../../../assets/fpga/benefits.png', title: 'Customer-Centric Approach', desc: 'Collaborative designs tailored to your requirements.'}
  ];
}
