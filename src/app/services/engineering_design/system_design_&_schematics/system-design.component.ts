...
export class SystemDesignComponent {
  ...
  industryStandards:any[] = [
    {imgUrl: '../../../../assets/system-design/industrial.png', title: 'Industry Standards', type1: 'IPC Standards', type2: 'ISO 9001', type3: 'RoHS Compliance', type4:'UL Certification'},
    {imgUrl: '../../../../assets/system-design/tvc.png', title: 'Testing & Validation Compliance', type1: 'EMC/EMI Testing', type2: 'ESD Standards', type3: 'Thermal Reliability Testing'},
    {imgUrl: '../../../../assets/system-design/grc.png', title: 'Global Regulatory Compliance', type1: 'FCC Compliance', type2: 'CE Marking', type3: 'UL and CSA Standards'}
  ];
