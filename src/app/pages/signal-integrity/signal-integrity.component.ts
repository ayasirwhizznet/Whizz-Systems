...
export class SignalIntegrityComponent {
  ...
  coreServices:any = [
    {imgUrl: '../../../assets/signalIntegrity/core-services.png', title: 'DDR Parallel Bus Analysis', desc: 'Evaluates timing, Simultaneous Switching Noise (SSN), voltage margins, and signal behavior for stable memory communication.'},
    {imgUrl: '../../../assets/signalIntegrity/core-services.png', title: 'S-Parameter Simulations', desc: 'Analyze high-speed interfaces for insertion loss, return loss, and TDR, identifying signal path discontinuities and crosstalk.'},
